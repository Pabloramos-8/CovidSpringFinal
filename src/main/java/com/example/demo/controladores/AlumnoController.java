...
public class AlumnoController {
	...
	public String  setProfesorToAlumno(@PathVariable String idAlumno,@PathVariable String idProfesor) {
	...
	public String postResponsableToAlumno(@RequestBody Responsable responsable,@PathVariable String idAlumno) {
		Optional<Alumno> alumnoOptional = as.findById(idAlumno);
		Alumno a= alumnoOptional.get();
	...
	public String deleteResponsableFromAlumno(@PathVariable String idAlumno,@PathVariable String idResponsable) {
		Optional<Alumno> alumnoOptional = as.findById(idAlumno);
		Alumno a= alumnoOptional.get();
